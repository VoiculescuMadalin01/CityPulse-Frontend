...
import { useAddNewSubCategory } from "@/hooks/queries/subcategory/useAddNewSubcategory"
import { ISubCategorySchemaZod } from "@/interfaces/subcategory/subcategory.interface"

function SubCategoryManagmentAdd() {
	...
	const { mutate, isPending } = useAddNewSubCategory()
...
export default SubCategoryManagmentAdd
